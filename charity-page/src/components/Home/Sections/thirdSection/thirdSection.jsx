    ...
    return (
        <div className='home-third-section'>
            ...
            <div className='right-third-section'>
                ...
                <ul>
                    <li><AiOutlineCheckCircle /> The standard chunk of Lorem Ipsum used since.</li>
                    <li><AiOutlineCheckCircle /> Randomised words which don't look even slightly believable.</li>
                    <li><AiOutlineCheckCircle /> Making this the first true generator on the Internet.</li>
                </ul>
